    ...
    public class OrdenCompraService : IOrdenCompraService
    {
        ...
        public async Task<OrdenCompraGetRes?> ObtenerOrdenCompra(int id)
        {
            ...
            var response = new OrdenCompraGetRes
            {
                ...
                Factura = (string.IsNullOrEmpty(s.SerieComprobante) && string.IsNullOrEmpty(s.NumeroComprobante)) ? "" : (s.SerieComprobante ?? "") + (string.IsNullOrEmpty(s.SerieComprobante) || string.IsNullOrEmpty(s.NumeroComprobante) ? "" : "-") + (s.NumeroComprobante ?? ""), 
