...
namespace Proy_back_QBD.Data
{
    public class ApiContext : DbContext
    {
        ...
        public DbSet<InsumoSede> InsumoSedes { get; set; }
        ...
        private void Configure(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Proveedor>((e) =>
           {
            ...
            modelBuilder.Entity<FormulaRapida>((e) =>
            {
                ...
                e.HasOne(x => x.Empaque).WithMany(w => w.FormulasRapidas).HasForeignKey(x => x.IdEmpaque);
                e.HasOne(x => x.Insumo).WithMany(w => w.FormulasRapidas).HasForeignKey(x => x.IdInsumo);
