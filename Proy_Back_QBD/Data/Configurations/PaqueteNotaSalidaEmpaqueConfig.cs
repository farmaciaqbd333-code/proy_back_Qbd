...
public class PaqueteNotaSalidaEmpaqueConfiguration : IEntityTypeConfiguration<PaqueteNotaSalidaEmpaque>
{
    public void Configure(EntityTypeBuilder<PaqueteNotaSalidaEmpaque> builder)
    {
        builder.ToTable("paquete_nota_salida_empaque");
        ...
        builder.Property(e => e.IdNotaSalidaEmpaque)
            .HasColumnName("id_nota_salida_empaque");
        ...
        builder.HasOne(e => e.Verificador)
            ...
            .HasConstraintName("fk_paquete_nota_salida_empaque_verificador")
            .IsRequired(false);

        builder.HasOne(e => e.NotaSalidaEmpaque)
            .WithMany(n => n.PaqueteNotaSalidaEmpaques)
            .HasForeignKey(e => e.IdNotaSalidaEmpaque)
            .IsRequired(false);
    }
}
