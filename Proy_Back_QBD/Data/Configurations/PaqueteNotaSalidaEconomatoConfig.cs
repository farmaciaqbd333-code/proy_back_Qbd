...
public class PaqueteNotaSalidaEconomatoConfiguration : IEntityTypeConfiguration<PaqueteNotaSalidaEconomato>
{
    public void Configure(EntityTypeBuilder<PaqueteNotaSalidaEconomato> builder)
    {
        builder.ToTable("paquete_nota_salida_economato");
        ...
        builder.Property(e => e.IdNotaSalidaEconomato)
            .HasColumnName("id_nota_salida_economato");
        ...
        builder.HasOne(e => e.Verificador)
            ...
            .HasConstraintName("fk_paquete_nota_salida_economato_verificador")
            .IsRequired(false);

        builder.HasOne(e => e.NotaSalidaEconomato)
            .WithMany(n => n.PaqueteNotaSalidaEconomatos)
            .HasForeignKey(e => e.IdNotaSalidaEconomato)
            .IsRequired(false);
    }
}
